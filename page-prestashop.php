...
<main>
  <div class="container">
    <h1 class="inline-block text-2xl bg-theme-brown border-2 border-gray-700 rounded px-4 py-2 mb-8"><?php _e("Сайти на CMS", "treba-wp"); ?> Prestashop</h1>
