...
<main>
  <div class="container">
    <h1 class="inline-block text-2xl bg-theme-brown border-2 border-gray-700 rounded px-4 py-2 mb-8"><?php _e("Вільні домени", "treba-wp"); ?></h1>
